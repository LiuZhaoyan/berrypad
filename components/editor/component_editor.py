...
class TextEditor(ComponentBasic):
    ...
    def _setup_tab_events(self) -> None:
        ...
        self.manager.subscribe("new_tab_generated", self.on_new_tab_generated)
    
    def on_new_tab_generated(self, tab_name: str) -> None:
        """处理新标签页创建事件"""
        self.tab_file_paths[tab_name] = None  # 新标签页没有关联文件
    
    def on_tab_switched(self, new_tab_frame) -> None:
        """处理标签页切换事件"""
    ...
    def get_current_text_area(self) -> tk.Text:
        """获取当前标签页的文本区域"""
